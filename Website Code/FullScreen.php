					...
					<!--<div class="fs-field-label fs-anim-upper">
						...
						<li data-input-trigger>
							...
							<div class="fs-radio-group fs-radio-custom clearfix fs-anim-lower">
								<span><input id="q6b" name="q6" type="radio" value="conversion"/><label for="q6b" class="radio-conversion">Earth Bending</label></span>
								<span><input id="q6c" name="q6" type="radio" value="social"/><label for="q6c" class="radio-social">Making fun of Sokka</label></span>
						...
						<li data-input-trigger>
							...
							<select class="cs-select cs-skin-boxes fs-anim-lower">
								...
								<option value="#588c75" data-class="color-588c75">Muslim Woman Library </option>
