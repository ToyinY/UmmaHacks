	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="DashboardFinal.html">
          <span class="align-middle">
			...
			?>
              ...
              <i class="align-middle" data-feather="credit-card"></i> <span class="align-middle">My Goals</span>
            </a>
					</li>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="img/avatars/avatar.jpg" class="avatar img-fluid rounded mr-1" alt="Charles Hall" /><span class="text-dark"><?php echo $row['name'];?></span>
              </a>
							<div class="dropdown-menu dropdown-menu-right">
								<a class="dropdown-item" href="pages-profile.html"><i class="align-middle mr-1" data-feather="user"></i> Profile</a>
								<a class="dropdown-item" href="#"><i class="align-middle mr-1" data-feather="pie-chart"></i> Progress</a>
							...
							<div class="w-100">
								<div class="row">
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">Productivity</h5>
												<h1 class="display-5 mt-1 mb-3">35 hours this week</h1>
												<div class="mb-1">
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">Mindfulness</h5>
												<h1 class="display-5 mt-1 mb-3">+2 Hours</h1>
												<div class="mb-1">
										...
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">Standing</h5>
												<h1 class="display-5 mt-1 mb-3">+2</h1>
												<div class="mb-1">
													<span class="text-danger"> <i class="mdi mdi-arrow-bottom-right"></i> -10% </span>
													<span class="text-muted">Since last week</span>
